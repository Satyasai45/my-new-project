...
import { AppBar, IconButton, InputBase, Menu, Toolbar, useTheme, Button, MenuItem, Box, Typography  } from '@mui/material';
                        ...
                        >
                          <Box
                            ...
                            <Box textAlign="left">
                                    ...
                                    <ArrowDropDownOutlined 
                                     sx={{colors: theme.palette.secondary[300], fontSize:"25px"}}
                                    />
                        </Button>
